        ...
        <div className="p-6 flex flex-col justify-start">
          ...
          <div className="flex items-center">
            <button
              ...
              onClick={() =>
                Router.pushRoute(
                  "/projects/projectLists/0xEe34c17aBf89803368a30b1f6a0131A3Cd4a8616"
                )
              }
            >
              View Project
            ...
            {props.investor ? (
              <button
                className="bg-orange-700 ml-5 hover:bg-orange-900 text-white font-bold py-2 px-4 rounded"
                              ...
                              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                  ...
                                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    >
                                      This project has a request that you must
                                      follow up on!
                                    </Dialog.Title>
                                    <div className="mt-2">
                                      <p className="text-sm text-gray-500">
                                        " Description ", " Current Investor
                                        Acceptance ", " Recepient ", " The
                                        Amount of ETH used "
                                      </p>
                                    </div>
                                  </div>
              ...
              <button
                ...
                onClick={() =>
                  Router.pushRoute(
                    "/projects/0xEe34c17aBf89803368a30b1f6a0131A3Cd4a8616/requests"
                  )
                }
              >
                View Requests
